...
best_practices = BestPractice.create(region: 1, general_knowledge: "Watchout bro!", personal_safety: "Not Safe Bro!", driving_conditions: "Drive MFckr", tipping_and_money: "$$$$", description:"Shalalal")
best_practices2 = BestPractice.create(region: 2, general_knowledge: "Los Hack Amigos!", personal_safety: "This is fine!", driving_conditions: "McDrive Trough", tipping_and_money: "$$", description:"Let's Go!")